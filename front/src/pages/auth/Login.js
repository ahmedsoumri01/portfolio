  ...
  return (
    ...
    <div className="flex h-screen">
      ...
      <div>
        ...
        <img src={myImage} alt="main" className="h-[80%] min-h-[100px] min-w-[100px] tm:h-[36px] tm:mt-[200px] sm:min-h-[100px] sm:min-w-[100px] sm:ml-[30px]" />
      </div>
      <div className="flex items-center justify-center w-full lg:w-1/2 bg-[#e2e4e6]">
        <form onSubmit={handleSubmit} className="w-full max-w-sm p-8 space-y-4">
          ...
          <Link to={"/resetpassword"}><span className="border-b border-gray-400 cursor-pointer">Forgot your password?</span>  </Link>  
          </p>
        </form>
      </div>
    </div>
